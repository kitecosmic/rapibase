    ...
    <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6">
      ...
      <article className="bg-white border border-gray-200 rounded-lg p-6 min-h-[60vh]">
        {loading ? (
          ...
          <div className="prose prose-sm max-w-none prose-headings:font-semibold prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-rose-700 prose-code:before:content-none prose-code:after:content-none prose-pre:bg-gray-900 prose-pre:text-gray-100 prose-a:text-blue-600">
            <ReactMarkdown
